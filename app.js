...
function addItem() {
    if (amountValue > 0) {
        const total = 519.00 * amountValue;
    wrp.classList.remove("empty");
    wrp.innerHTML = `<div class="product">
                    <div>
                      <img src="./images/img-prod-1.png" class="product-img" alt="product">
                      <div class="product-info">
                        <p class="product-title">Fall Limited Edition Sneakers</p>
                       <p><span>R$519.00</span> × <span class="number">${amountValue}</span> <b>$${total}</b></p>
                      </div>
...
images.forEach((image) => {
  image.addEventListener("click", () => {
    ...
    switch (selectedImg.getAttribute("src")) {
      case "./images/img-prod-1.png":
        mainThumbnail.src = "./images/img-prod-1.png";
        mainThumbnailLightBox.src = "./images/img-prod-1.png";
        break;
      case "./images/img-prod-2.png":
        mainThumbnail.src = "./images/img-prod-2.png";
        mainThumbnailLightBox.src = "./images/img-prod-2.png";
        break;
      case "./images/img-prod-3.png":
        mainThumbnail.src = "./images/img-prod-3.png";
        mainThumbnailLightBox.src = "./images/img-prod-3.png";
        break;
        /*
        case "./images/img-prod-4.png":
        mainThumbnail.src = "./images/img-prod-4.png";
        mainThumbnailLightBox.src = "./images/img-prod-4.png";
        break;
        */
    }
  });
